...
const galleryPaths = (id, count = 6) =>
  Array.from({ length: count }, (_, i) => imageItem(`assets/images/${id}/${id}_${String(i + 1).padStart(2, '0')}.png`, `IMAGE ${String(i + 1).padStart(2, '0')}`));
...
const CHARACTERS = [
  {
    ...
    mainImage: 'assets/images/seol-gongchan/seol-gongchan_01.png',
    gallery: galleryPaths('seol-gongchan', 6),
